...
@app.route('/stu_pro')
def stu_pro():
    return  render_template('stu_progressbar.html')

@app.route('/stu_swee')
def stu_swee():
    return render_template('stu_swee.html')

@app.route('/stu_data')
def stu_data():
    return render_template('stu_data.html')

@app.route('/stu_valid')
def stu_valid():
    return render_template('stu_formvaild.html')

## ajax:
@app.route('/stu_ajax')
def stu_ajax():
    return render_template('stu_ajax.html')
...
@app.route('/stu_echarts_map')
def stu_echarts_map():
    return render_template('stu_echart_map.html')


# 监控
@app.route('/mem')
def monitor_mem():
    return  render_template('/monitor/monitor_mem.html')

@app.route('/mem_data')
def mem_data():
    sql = 'select mem,time from mem'
    cur.execute(sql)
    res = []
    for c in cur.fetchall():
        res.append({
